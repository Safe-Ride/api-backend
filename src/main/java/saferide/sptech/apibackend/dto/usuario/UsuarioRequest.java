...
public class UsuarioRequest {
    ...
    @NotBlank(message = SafeRideConstants.USUARIO_INVALID_NOME)
    ...
    @NotBlank(message = SafeRideConstants.USUARIO_INVALID_DATA_NASCIMENTO)
    @Pattern(regexp = SafeRideConstants.REGEX_DATA_NASCIMENTO, message = SafeRideConstants.USUARIO_INVALID_DATA_NASCIMENTO)
    private LocalDate dataNascimento;
    @NotBlank(message = SafeRideConstants.USUARIO_INVALID_TIPO)
